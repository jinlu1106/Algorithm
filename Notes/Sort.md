...
+ 实现过程：
  ...
  ![2](../Picture/Algorithm/3.gif)

  ![3](../Picture/Algorithm/2.gif)
...
+ 实现过程：
  ...
  ![5](../Picture/Algorithm/5.gif)

  使用选择排序为一列数字进行排序的宏观过程
  ![6](../Picture/Algorithm/6.gif)
...
+ 实现过程：
  ...
  ![7](../Picture/Algorithm/7.gif)

  使用插入排序为一列数字进行排序的宏观过程：
  ![8](../Picture/Algorithm/8.gif)
